  ...
  public function login_post()
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      if (isset($login_output) && $login_output) {
        ...
        // Generate Token
        $token_data = [
          'id' => $login_output[0]['Customer_ID'], //Recommend for Token
          'Customer_No' => $login_output[0]['Customer_No'],
          'UserName' => $login_output[0]['UserName'],
          'FirstName' => $login_output[0]['Name'],
          'LastName' => $login_output[0]['Surname'],
          'Phone_Number' => $login_output[0]['Phone_Number'],
